...
while True:
        ...
        for pt in center_points_cur_frame:
            for pt2 in center_points_prev_frame:
                ...
                if distance < 30:
                    ...
                    #cv2.line(frame, pt, pt2, (255, 0, 0), thickness=2)
    else:
    ...
    #for object_id, poline in polylines[[]]:
     #   cv2.polylines(frame, [poline], (255, 0, 0), thickness=2)

    for line in polylinesAr:
        pt1 = line[0]
        pt2 = line[1]
        cv2.line(frame, (pt1[0], pt1[1]), (pt2[0], pt2[1]), (255, 0, 0), thickness=2)
        #cv2.polylines(frame, [pts], 1, (255, 0, 0), thickness=2)
